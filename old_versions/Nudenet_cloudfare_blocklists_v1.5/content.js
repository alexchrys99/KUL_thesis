...
const requestDelay = 0; // Changed from 1 second to 0
...
// Update the blur stats when an image is blurred
...
async function processImage(img) {
    ...
    try {
        ...
        const result = await makeRequest('https://4266-2a02-85f-ec74-d400-e418-eeb5-7824-8cf0.ngrok-free.app/predict', {
            method: 'POST',
